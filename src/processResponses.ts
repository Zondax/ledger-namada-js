...
export function processSpendRandomnessResponse(response: Buffer): ResponseGetSpendRandomness {
  const errorCodeData = response.subarray(-2)
  const returnCode = errorCodeData[0] * 256 + errorCodeData[1]
...
export function processOutputRandomnessResponse(response: Buffer): ResponseGetOutputRandomness {
  const errorCodeData = response.subarray(-2)
  const returnCode = errorCodeData[0] * 256 + errorCodeData[1]
...
export function processConvertRandomnessResponse(response: Buffer): ResponseGetConvertRandomness {
  const errorCodeData = response.subarray(-2)
  const returnCode = errorCodeData[0] * 256 + errorCodeData[1]
...
export function processMaspSign(response: Buffer): ResponseSignMasp {
  const errorCodeData = response.subarray(-2)
  const returnCode = errorCodeData[0] * 256 + errorCodeData[1]
